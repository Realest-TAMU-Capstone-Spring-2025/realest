...
/// A widget representing a single item in a bottom navigation bar for investors.
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Icon(
                icon,
                color: isSelected ? Color(0xFFEBA682) : Colors.white, // Orange when selected.
              ),
            ),
            ...
            if (isSelected)
              Container(
                ...
                height: 2,
                width: 50,
                color: Color(0xFFEBA682), // Orange underline.
              ),
          ],
        ),
      ),
