...
class InvestorSettingsScreen extends StatefulWidget {
  const InvestorSettingsScreen({Key? key}) : super(key: key);

  @override
  _InvestorsSettingsPageState createState() => _InvestorsSettingsPageState();
}

class _InvestorsSettingsPageState extends State<InvestorSettingsScreen> {
  ...
  void _onItemTapped(int index) {
    if (index == 0) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => const InvestorRealtorScreen()),
      );
    } else if (index == 2) {
      // Already on Settings.
      Navigator.pushReplacement(
