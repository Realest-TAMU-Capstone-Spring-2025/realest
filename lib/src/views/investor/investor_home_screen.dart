...
class _InvestorHomeScreenState extends State<InvestorHomeScreen> {
  ...
  void _onItemTapped(int index) {
    ...
    if (index == 0) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => InvestorRealtorScreen()),
      );
    } else if (index == 2) {
      // Already on Settings, do nothing.
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => InvestorDashboardScreen()),
      );
    }else if (index == 3) {
      // Already on Settings, do nothing.
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => InvestorSettingsScreen()),
      );
    }
                  ...
                  child: SingleChildScrollView(
                    child: Wrap(
                      ...
                      children: _appliedFilters.map((filter) {
                        return Chip(
                          backgroundColor: const Color(0xFF127B86),
                          label: Text(filter,
                              style: GoogleFonts.openSans(
                                  color: Colors.white)),
                          onDeleted: () {
